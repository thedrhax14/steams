<template>
	<div id="app">
		...
		<Push v-if='IsAvailable' width="250">
			<span>
			<h1  v-if="this.$store.state.userInfo.PermissionLevel == 0">User</h1>
			<h1  v-if="this.$store.state.userInfo.PermissionLevel == 1">operator</h1>
			<h1  v-if="this.$store.state.userInfo.PermissionLevel == 2">Manager</h1>
		</span>
