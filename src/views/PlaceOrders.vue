<template>
  <div class="placeorder">
    ...
    <div class="card">
      ...
      <button type="button" class="btn btn-danger btn-lg"  @click="value = 'repair'">Repair Bikes</button>
      <button type="button" class="btn btn-danger btn-lg" @click=" value ='order_new' ">Order New Bikes</button>
      </div>
      </div>
      <div class="card-body">
          ...
          <form action="">
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input v-model="repairBID" type="text" pattern="[A-Z]{2}[0-9]{5}" size ="7"class="form-control" id="inputNumber4"  placeholder="CD00987" required>
           ...
           <div class="container-fluid"  v-show="value === 'order_new'">
